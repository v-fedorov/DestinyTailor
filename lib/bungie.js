var Character = require('../models/character'),
    CharacterFormatter = require('./formatters/characterFormatter'),
 ...
 */
Bungie.prototype.getCharacter = function(platform, accountId, characterId, callback) {
    ...
    this.request(options, function(err, result) {
        ...
        var character = new Character(platform, accountId, characterId),
            characterFormatter = new CharacterFormatter(result.definitions);
 ...
 */
Bungie.prototype.getInventory = function(platform, accountId, characterId, callback) {
 ...
 */
Bungie.prototype.getInventoryItem = function(platform, accountId, characterId, itemId, callback) {

 ...
 * @constructor
 */
function InstanceItemFormatter() { };

/**
 * Gets the item from the parser.
 * @param {number} data The item's raw data.
 * @param {object} definitions The definitions.
 * @returns The item.
 */
InstanceItemFormatter.prototype.getItem = function(data, definitions) {
    var item = new Item();
 ...
 */
var ItemBucketHashType = InstanceItemFormatter.ItemBucketHashType = {
      '434908299':  'artifact',
      '14239492':   'chest',
...
module.exports = InstanceItemFormatter;

var BungieApi = require('./bungieApi'),
 ...
 */
BungieService.prototype.getCharacter = function(character, callback) {
    this.api.getCharacter(character.platform, character.accountId, character.id, function(err, result) {
        if (err !== null) {
            return callback(err);
        };
 ...
 */
BungieService.prototype.getInventory = function(character, callback) {
    this.api.getInventory(character.platform, character.accountId, character.id, function(err, result) {
        callback(err, result);
    });
};
 ...
 */
BungieService.prototype.getInventoryItem = function(character, itemId, callback) {
    // todo: consider caching
    this.api.getInventoryItem(character.platform, character.accountId, character.id, itemId, function(err, result) {
